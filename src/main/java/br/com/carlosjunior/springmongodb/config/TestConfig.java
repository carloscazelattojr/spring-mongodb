package br.com.carlosjunior.springmongodb.config;
...
public class TestConfig {
    ...
    public void init() {
        ...
        Post post1 = new Post(null, Instant.parse("2023-02-13T11:15:01Z"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", new Author(maria));
        Post post2 = new Post(null, Instant.parse("2023-02-14T10:05:49Z"), "Bom dia", "Acordei feliz hoje!", new Author());

        Comment c1 = new Comment("Boa viagem mano!", Instant.parse("2023-02-13T14:30:01Z"), new Author(alex));
